...
def make_interpreter(model_file):
  ...
  try:
    ...
    print("Coral USB-Acculator nicht angesteckt, entweder Co-Prozessor anstecken oder Auffruf ändern:") 
    print("python3 classify_image4cpu.py --model model/model_quantized.tflite --labels model/labels.txt --input image.jpg ") 
    #exit()
    sys.exit()
